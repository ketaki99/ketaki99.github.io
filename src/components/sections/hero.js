...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Ketaki Gokhale</h2>;
  // const three = <h3 className="big-heading">I bring ideas to life through code. </h3>;
  const four = (
    <>
      <p>
        ...
        . My interests lie at the intersection of Machine Learning and Software Development. I’m
